...
CREATE TABLE IF NOT EXISTS wrong_questions (
  ...
  KEY idx_wrong_mastered (user_id, mastered)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO quiz_questions (question, options, answer_index, explanation) VALUES
  ('以下哪种植物属于多肉植物？', JSON_ARRAY('月季', '吉娃娃', '碗莲', '龟背竹'), 1, '吉娃娃为景天科拟石莲属多肉植物。'),
  ('多肉植物夏季施肥的原则是？', JSON_ARRAY('薄肥勤施', '大量施肥', '停止施肥', '只施氮肥'), 2, '夏季高温多数多肉休眠，应停止施肥避免肥害。'),
  ('月季黑斑病的典型症状是？', JSON_ARRAY('叶片白粉', '黑色圆形斑点', '叶背蛛网', '叶片卷曲'), 1, '黑斑病叶片出现黑色圆形斑点，边缘放射状。'),
  ('龟背竹适合的光照条件是？', JSON_ARRAY('全日照', '散射光', '完全黑暗', '强直射光'), 1, '龟背竹耐阴，适合明亮散射光环境。'),
  ('换盆的最佳季节通常是？', JSON_ARRAY('夏季', '深冬', '春季', '雨季'), 2, '春季气温回升、根系活跃，是换盆最佳时机。'),
  ('“见干见湿”的浇水原则适用于？', JSON_ARRAY('所有植物', '多肉植物', '绝大多数盆栽植物', '水生植物'), 2, '绝大多数盆栽植物遵循见干见湿原则。');
